...
* [FidelusAleksander/prompt-action](https://github.com/actions/ai-inference): A GitHub Action that lets you Prompt AI directly in your workflows with support for structured outputs and prompt templating.
